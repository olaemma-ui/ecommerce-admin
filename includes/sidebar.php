                ...
                <div class="section-menu-left">
                    ...
                    <div class="center">
                        ...
                        <div class="center-item">
                            ...
                            <ul class="menu-list">
                                <li class="<?= strpos($current_page, 'product') !== false ? 'menu-item has-children active' : 'menu-item has-children' ?>">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                ...
                                <li class="<?= strpos($current_page, 'category') !== false ? 'menu-item has-children active' : 'menu-item has-children' ?>">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="category-list.php" class="<?= $current_page == 'category-list.php' ? 'active' : '' ?>">
                                                <div class="text">Category list</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="new-category.php" class="<?= $current_page == 'new-category.php' ? 'active' : '' ?>">
                                                <div class="text">New category</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="<?= strpos($current_page, 'brand') !== false ? 'menu-item has-children active' : 'menu-item has-children' ?>">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        <div class="icon"><i class="icon-layers"></i></div>
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="brand-list.php" class="<?= $current_page == 'brand-list.php' ? 'active' : '' ?>">
                                                <div class="text">Brand list</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="new-brand.php" class="<?= $current_page == 'new-brand.php' ? 'active' : '' ?>">
