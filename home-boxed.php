...
<body class="body">
    ...
    <div id="wrapper">
        ...
        <div id="page" class="">
            <!-- layout-wrap -->
            <div class="layout-wrap layout-width-boxed">
                <!-- preload -->
                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children active">
                                    ...
                                    <ul class="sub-menu" style="display: block;">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="home-boxed.php" class="active">
                                            ...
                                            <ul class="flex flex-column gap10">
                                                <li class="product-item gap14">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
                                                            <a href="product-list.php" class="body-title-2">Taste of the Wild Formula Finder</a>
                                                        </div>
                                                ...
                                                <li class="product-item gap14">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
                                                            <a href="product-list.php" class="body-title-2">Proden Plaqueoff Dental Bites Dog, 150 G</a>
                                                        </div>
                                                        <div class="body-text">2,672</div>
                                                        <div class="body-text">$28,672.36</div>
                                                ...
                                                <li class="product-item gap14">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
                                                            <a href="product-list.php" class="body-title-2">Zuke's Lil' Links Healthy Little Sausage Links for Dogs...</a>
                                                        </div>
                                                        <div class="body-text">2,672</div>
                                                        <div class="body-text">$28,672.36</div>
                                                        <div class="body-text">X1</div>
                                                ...
                                                <li class="product-item gap14">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
                                                            <a href="product-list.php" class="body-title-2">Rachael Ray Nutrish Grain Free Chicken Drumstick...</a>
                                                        </div>
                                                        <div class="body-text">2,672</div>
                                                        <div class="body-text">$28,672.36</div>
                                                ...
                                                <li class="product-item gap14">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
                                                            <a href="product-list.php" class="body-title-2">Fruitables Dog Treats Sweet Potato & Pecan Flavor</a>
                                                        </div>
                                                        <div class="body-text">2,672</div>
                                                        <div class="body-text">$28,672.36</div>
                                                        <div class="body-text">X2</div>
                                        ...
                                        <div class="wg-table table-product-overview t4">
                                            ...
                                            <ul class="flex flex-column gap10">
                                                ...
                                                <li class="product-item gap14">
                                                    ...
                                                    <div class="flex items-center justify-between gap20 flex-grow">
                                                        <div class="name">
                                                            <a href="product-list.php" class="body-text">Milk-Bone Mini's Flavor Snacks Dog Treats, 15...</a>
                                                        </div>
                                                        <div class="body-text">#70668</div>
                                                        <div class="body-text">$450</div>
                                                        <div class="body-text">$28,672.36</div>
