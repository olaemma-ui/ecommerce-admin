                    ...
                    <div class="center">
                        ...
                        <div class="center-item">
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <a href="gallery.php" class="menu-item-button">
                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children active">
                                    ...
                                    <ul class="sub-menu" style="display: block;">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="cities.php" class="active">
                                ...
                                <div class="wg-box">
                                    ...
                                    <div class="wg-table table-countries wrap-checkbox">
                                        <ul class="table-title flex gap20 mb-14">
                                            ...
                                            <li>
                                                <div class="body-title">State</div>
                                            </li>
                                            <li>
                                        ...
                                        <ul class="flex flex-column">
                                            <li class="countries-item">
                                                ...
                                                <div class="body-text">Baton Rouge (LA)</div>
                                            ...
                                            <li class="countries-item">
                                                ...
                                                <div class="body-text">Resistencia</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">20 Nov 2023</div>
                                                <div>
                                            ...
                                            <li class="countries-item">
                                                ...
                                                <div class="body-text">North Las Vegas (NV)</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">20 Nov 2023</div>
                                                <div>
                                            ...
                                            <li class="countries-item">
                                                ...
                                                <div class="body-text">Mönchengladbach</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">20 Nov 2023</div>
                                                <div>
                                            ...
                                            <li class="countries-item">
                                                ...
                                                <div class="body-text">San Juan</div>
                                            ...
                                            <li class="countries-item">
                                                ...
                                                <div class="body-text">Chelyabinsk	</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">20 Nov 2023</div>
                                                <div>
                                            ...
                                            <li class="countries-item">
                                                ...
                                                <div class="body-text">Ontario (CA)</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">Vietnamese</div>
                                                <div class="body-text">20 Nov 2023</div>
                                                <div>
