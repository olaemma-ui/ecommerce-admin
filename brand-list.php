...
$elements_per_page = 10; // Number of brand per page
...
$response = $brandService->getAllBrand(
    $current_page,
    $elements_per_page
);
            ...
            <div class="main-content-wrap">
                ...
                <div class="wg-box">
                    <div class="flex items-center justify-between gap10 flex-wrap">
                        ...
                        <a class="tf-button style-1 w208" href="new-brand.php"><i class="icon-plus"></i>Add new</a>
                    </div>
                    <div class="overflo" style="overflow-x: auto;">


                        <div class="wg-table table-all-brand" style="width: max-content; min-width: 100% !important; overflow-x: auto;">
                            <ul class="table-title flex  mb-14 px-4 justify-content-between" style="width: fit-content; min-width: 100% !important;">
                                <li style="min-width: 100px;">
                                    <div class="body-title">SN</div>
                                </li>
                                <li style="min-width: 100px;">
                                    <div class="body-title">Brand logo</div>
                                </li>
                            ...
                            <?php
                            if (isset($response) && !empty($response['data']['brand'])) {
                                $count = 0;
                                while ($count < count($response['data']['brand'])) {
                                    echo '
                                        <ul class="product-item table-title flex px-4 mb-14" style="width: fit-content; min-width: 100% !important;">
                                        <li style="min-width: 100px">
                                            <div class="body-title">' . ($count + 1) . '</div>
                                        </li>
                                        <li style="min-width: 100px">
                                            <img src="' . $response['data']['brand'][$count]['logo_url'] . '" style="width: 40px; height: 40px;" class="rounded-pill" />
                                        </li>
                                        <li style="min-width: 100px">
                                            <div class="body-text">' . $response['data']['brand'][$count]['brand_name'] . '</div>
                                        </li>
        
                                        <li style="min-width: 100px">
                                            <div class="body-text">' . date("Y-m-d", strtotime($response['data']['brand'][$count]['dateCreated'])) . '</div>
                                        </li>
                                        <li style="min-width: 100px">
                                            <div class="list-icon-function">
                                                <a href="new-brand.php?id=' . $response['data']['brand'][$count]['brand_id'] . '&action=update&name=' . $response['data']['brand'][$count]['brand_name'] . '" class="item edit">
