                        ...
                        <div class="wg-table table-top-product">
                            <ul class="flex flex-column gap14">
                                ...
                                <li class="product-item">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-title-2">Nulo MedalSeries Adult Cat...</a>
                                            <div class="text-tiny mt-3">100 Items</div>
                                        </div>
                                        <div>
                                            <div class="text-tiny mb-3">Coupon Code</div>
                                ...
                                <li class="product-item">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-title-2">Pedigree Puppy Dry Dog...</a>
                                            <div class="text-tiny mt-3">100 Items</div>
                                        </div>
                                        <div>
                                            <div class="text-tiny mb-3">Coupon Code</div>
                                ...
                                <li class="product-item">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-title-2">Biscoito Premier Cookie...</a>
                                            <div class="text-tiny mt-3">100 Items</div>
                                        </div>
                                        <div>
                                            <div class="text-tiny mb-3">Coupon Code</div>
                                ...
                                <li class="product-item">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-title-2 mb-3">Pedigree Adult Dry Dog...</a>
                        ...
                        <div class="wg-table table-product-overview">
                            ...
                            <ul class="flex flex-column gap10">
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Soft Fluffy Cats</a>
                                        </div>
                                ...
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Taste of the Wild Formula Finder</a>
                                        </div>
                                ...
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Wellness Natural Food</a>
                                        </div>
                                ...
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Dog Food Rachael Ray</a>
                                        </div>
                                ...
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Best Buddy Bits Dog Treats</a>
                                        </div>
                            ...
                            <ul class="flex flex-column gap18">
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow gap10">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Prodotti per il tuo cane...</a>
                                        </div>
                                ...
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow gap10">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Wholesome Pride...</a>
                                        </div>
                                        <div class="body-text">20 Nov 2023</div>
                                        <div class="body-text">20 Nov 2023</div>
                                    </div>
                                ...
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow gap10">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Beneful Baked Delights...</a>
                                        </div>
                                        <div class="body-text">20 Nov 2023</div>
                                        <div class="body-text">20 Nov 2023</div>
                                    </div>
                                ...
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow gap10">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Taste of the Wild...</a>
                                        </div>
                                        <div class="body-text">20 Nov 2023</div>
                                        <div class="body-text">20 Nov 2023</div>
                                    </div>
                                ...
                                <li class="product-item gap14">
                                    ...
                                    <div class="flex items-center justify-between flex-grow gap10">
                                        <div class="name">
                                            <a href="product-list.php" class="body-text">Canagan - Britain's...</a>
                                        </div>
                                        <div class="body-text">20 Nov 2023</div>
                                        <div class="body-text">20 Nov 2023</div>
                                    </div>
                    ...
                    <div class="wg-box">
                        ...
                        <ul class="flex flex-column gap20 overflow-h">
                            <li class="comment-item">
                                ...
                                <div class="">
                                    <div class="mb-4 name">
                                        <a href="all-user.php" class="body-title-2">Kathryn Murphy</a>
                                    </div>
                            ...
                            <li class="comment-item">
                                ...
                                <div class="">
                                    <div class="mb-4 name">
                                        <a href="all-user.php" class="body-title-2">Leslie Alexander</a>
                                    </div>
                                    <div class="ratings mb-10">
                                        <i class="icon-star1 active"></i>
                                        <i class="icon-star1 active"></i>
                            ...
                            <li class="comment-item">
                                ...
                                <div class="">
                                    <div class="mb-4 name">
                                        <a href="all-user.php" class="body-title-2">Eleanor Pena</a>
                                    </div>
                                    <div class="ratings mb-10">
                                        <i class="icon-star1 active"></i>
                                        <i class="icon-star1 active"></i>
